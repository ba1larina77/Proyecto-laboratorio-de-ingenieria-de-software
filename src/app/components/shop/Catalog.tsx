    ...
    <div>
      ...
      {(() => {
        ...
        if (isSubscribed) {
          ...
          // Libros que coinciden con alguna preferencia del usuario
          const preferenceBooks = userPrefs.length > 0
            ? sorted.filter(b =>
            ...
            : sorted; // sin preferencias definidas → mostrar todos

          // Nuevos ingresos que coincidan con preferencias
          const subscriptionBooks = preferenceBooks.filter(b => b.isNew);
