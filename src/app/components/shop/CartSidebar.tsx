            ...
            cart.map(item => (
              <div key={item.book.id} className="flex gap-4 py-4 border-b" style={{ borderColor: "#F5EDD3" }}>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs mb-0.5" style={{ color: "#6B5344", opacity: 0.7 }}>{item.book.author}</p>
                  <p className="text-[10px] font-mono mb-1.5" style={{ color: "#6B5344", opacity: 0.6 }}>ID libro: {item.book.id}</p>
