...
const INITIAL_BOOKS: Book[] = [
  ...
  { id: 9, title: "Don Quijote de la Mancha", author: "Miguel de Cervantes", category: "Ficción", price: 38000, rating: 4.5, isNew: false, available: true, stock: 6, cover: "https://images.unsplash.com/photo-1543002588-bfa74002ed7e?w=300&h=450&fit=fit=crop", isbn: "978-84-9895-001-5" },
...
export function ShopProvider({ children }: { children: ReactNode }) {
  ...
  const [walletTransactions, setWalletTransactions] = useState<WalletTransaction[]>(INITIAL_WALLET_TXS);
  ...
  const cancelOrder = useCallback((orderId: string) => {
    ...
    setUser(prev => prev ? { ...prev, balance: prev.balance + order.total } : prev);
